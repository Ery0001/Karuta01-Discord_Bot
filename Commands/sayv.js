module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if(!message.member.permissions.has("MANAGE_WEBHOOKS", "ADMINISTRATOR")) { //need manage messages permission to prevent people use this cmd wrong
            return message.reply({ content: '**` ⛩️You do not have permission to use this command⛩️ `**'})//like sending the msg to announcement channel...
